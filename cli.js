...
const options = argv.usage('Usage: $0 path [options]')
    ...
    .boolean('limit-scope')
    .describe('limit-scope', 'allow to follow URLs which are out of provided scope, like ../somewhere')
    .boolean('javadoc')
    .describe('javadoc', 'Enable special URL transforming which allows to check iframe deeplinks for javadoc and scaladoc')
